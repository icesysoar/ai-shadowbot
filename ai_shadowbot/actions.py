...
ACTION_TYPES: List[Dict[str, Any]] = [
    ...
    # ---- 浏览器自动化 (F015) ----
    {"type": "browser_navigate", "params": {"url": str}, "required": ["url"], "dangerous": False,
     "desc": "在浏览器中打开指定网页"},
    {"type": "browser_click", "params": {"x": int, "y": int}, "required": ["x", "y"], "dangerous": False,
     "desc": "在浏览器中点击指定坐标"},
    {"type": "browser_type", "params": {"text": str}, "required": ["text"], "dangerous": False,
     "desc": "在浏览器当前焦点输入文本"},
    {"type": "browser_screenshot", "params": {}, "required": [], "dangerous": False,
     "desc": "截取当前浏览器页面"},
    {"type": "browser_wait", "params": {"seconds": (int, float)}, "required": ["seconds"], "dangerous": False,
     "desc": "在浏览器中等待指定秒数"},
    {"type": "browser_scroll", "params": {"dx": int, "dy": int}, "required": ["dx", "dy"], "dangerous": False,
     "desc": "在浏览器中滚动页面"},
    {"type": "browser_extract_text", "params": {"selector": str}, "required": [], "dangerous": False,
     "desc": "提取浏览器页面中的文本内容"},
    # ---- Excel/CSV (F016) ----
